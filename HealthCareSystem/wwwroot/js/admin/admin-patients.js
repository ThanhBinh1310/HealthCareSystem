        ...
        <tr>
            ...
            <td>
                <div class="btn-group" role="group">
                    <a href="/Admin/PatientEdit/${user.userId}" class="btn btn-sm btn-outline-primary" title="Edit">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="/Admin/PatientDetail/${user.userId}" class="btn btn-sm btn-outline-info" title="View">
                        <i class="fas fa-eye"></i>
                    </a>
                    <a href="/Admin/PatientDelete/${user.userId}" class="btn btn-sm btn-outline-danger" title="Delete">
